...
| 날짜 | 작업자 | 유형 | 내용 |
|------|--------|------|------|
| 2026-02-26 15:45 | 박재현 | 추가 | origin/feature/admin push 고급 설정 내 동적 탭 개수 제한 기능 및 탭 드래그 앤 드롭 순서 변경 기능 구현, 전역 미니멀 스크롤바 디자인 적용 |
...
| 2026-02-18 08:55 | 박지은 | 수정 | 알림규칙 스케줄러를 규칙별 interval_min에 따라 실행하도록 개선 |
| 2026-02-16 17:45 | 박지은 | 리팩터 | 알림 기능 디렉토리 구조 개선 및 TabManager import 경로 수정 완료 |
| 2026-02-16 17:00 | 박지은 | 수정 | 알림규칙목록/알림내역 필터를 테이블 헤더로 이동 (검색 기능 정상작동 확인) |
| 2026-02-16 16:53 | 박지은 | 리팩터 | 알림규칙목록/알림내역 테이블 UI 통일화 (폰트, 스타일, 날짜 포맷) |
| 2026-02-16 16:53 | 박지은 | 수정 | UTC 타임스탬프를 브라우저 로컬 타임으로 명시적 변환 (formatDateTime 유틸리티) |
...
| 2026-02-25 08:22 | Gemini | 배포 | origin/feature/dashboard push (차트 색상 테마 적용 및 피드백 반영) |
