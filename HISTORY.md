...
| 2026-02-26 10:55 | 박상현 | 수정 | 로그 검색창 입력 시 실시간 필터링 방지 및 엔터 키 입력 시에만 검색이 적용되도록 개선 |
| 2026-02-26 10:45 | 박상현 | 수정 | 로그 검색창과 필터 칩 분리 및 OpenSearch Lucene 쿼리 문법(AND/OR/NOT) 지원 고도화 |
| 2026-02-26 10:35 | 박상현 | 수리 | 로그 스트리밍 화면의 ReferenceError(searchQuery is not defined) 해결 및 린트 오류 최적화 |
| 2026-02-26 10:25 | 박상현 | 수정 | 로그 스트리밍 테이블 TIMESTAMP 헤더(날짜)와 행 데이터(시간) 표시 형식 분리 및 너비 최적화 |
| 2026-02-26 10:15 | 박상현 | 추가 | 로그 스트리밍 필드 동적 선택 기능 및 상세 패널 전용 아이콘을 통한 필터링 구현 |
