...
| 날짜 | 작업자 | 유형 | 내용 |
|------|--------|------|------|
| 2026-01-29 | 김장훈 | 리팩터 | ASSISTANT.md 신규 생성, CLAUDE.md/GEMINI.md 공통 가이드 분리 |
| 2026-01-29 | 김장훈 | 추가 | ROADMAP.md 기능 개발 로드맵 생성 |
| 2026-01-29 | 김장훈 | 수정 | CLAUDE.md MUI 테마/모달/i18n 내용 정리 및 중복 제거 |
| 2026-01-29 | 김장훈 | 수정 | GEMINI.md CLAUDE.md와 동기화 (MUI/i18n/테마/모달 반영) |
| 2026-01-29 | 김장훈 | 추가 | docs/figma/resolver/ 어택라인, 프로세스트리 디자인 파일 |
