...
## 모든 md등 행동 강령은 주석을 제외하고 300자를 넘기지 않는 것이 효과적입니다.

## 필수 행동 강령

### 원격 Git Push 금지 (사용자 명령 필수)

> **사용자의 직접적인 명령 없이 원격 브랜치에 Push하는 행위를 엄격히 금지함.**
>
...
- AI 개발툴은 CLAUDE와 GEMINI를 사용
- 공통 가이드는 이 파일(`ASSISTANT.md`)에서 관리하며, `CLAUDE.md`와 `GEMINI.md`는 이 파일을 참조
