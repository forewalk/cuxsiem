...
| 날짜 | 작업자 | 유형 | 내용 |
|------|--------|------|------|
| 2026-03-10 16:50 | 박상현 | 수리 | 백엔드 SyntaxError 수정 (f-string 역슬래시 제약 해결) |
| 2026-03-10 16:45 | 박상현 | 배포 | origin/develop push (사용자 신청 활성화 및 401 에러 수정, 알림 템플릿 개선, 대시보드 무한루프 및 중복호출 해결, 윈도우 경로 검색 지원) |
